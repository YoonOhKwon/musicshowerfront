...
AESTHETIC (association): controlled metaphor and deep cultural/visual associations are strongly encouraged here. You can freely use historical and cultural metaphors (e.g. 일본 버블경제, 과거의 향기, 재해석, 80/90년대 감성) and aesthetic labels like ~코어 (~core) or ~미학. Keep an impression-register ending (~의 결, ~같은, ~감성, ~인상, ~미학, ~코어) to signal an association rather than a strict measurement.
IMPRESSION (mood): concise, genuinely poetic subjective impression is ALLOWED and highly encouraged here. Go deep into the emotional interpretation and appreciation of the music, similar to advanced music curation AIs (e.g., Suno AI). Synthesize multiple features (warmth + rhythm + genre context) to evoke feelings like 향수, 낭만, 애상.
Use only these transformations: A musical literalization; B interpretive compression of 2+ facts; C kinetic metaphor grounded in rhythm/timing; D spatial metaphor grounded in mix/reverb evidence; E material metaphor grounded in timbre; F emotional synthesis of distinct mood/music axes; G cultural compression grounded in verified context; H rich aesthetic/cultural neologisms (like -core/-코어) if deeply aligned with the genre context.
Forbidden everywhere: unobserved scenery/memory/person narratives (unless framed as an aesthetic vibe), song/artist identification, actual recording date/place/creator claims, filling quotas, and the generic AI-poetry vocabulary this project has already rejected as meaningless with any music (과열된 긴장, 냉각된 긴장, 저중력 부유, 유리 같은 고독, 금속성 황홀, and equivalents).
